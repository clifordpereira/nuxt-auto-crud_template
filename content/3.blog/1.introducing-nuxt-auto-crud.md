...
image:
  src: /images/blog/1.introducing-nuxt-auto-crud.png
authors:
...
**Nuxt Auto CRUD** is a module designed to eliminate this boilerplate. It takes your [Drizzle ORM](https://orm.drizzle.team/) schema and automatically mounts fully-featured RESTful APIs.
...
- `GET /api/_nac/posts` - List all posts (with pagination, filtering, sorting)
- `GET /api/_nac/posts/:id` - Get a single post
- `POST /api/_nac/posts` - Create a new post
- `PATCH /api/_nac/posts/:id` - Update a post
- `DELETE /api/_nac/posts/:id` - Delete a post
