...
- **`NUXT_PUBLIC_GA_ID`**: (Optional) Your Google Analytics 4 property ID for tracking user analytics and site performance.
- **`NUXT_PUBLIC_ADS_ID`**: (Optional) Your Google Ads conversion tracking ID for monitoring ad performance and conversions.
