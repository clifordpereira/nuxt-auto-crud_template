...
| :--- | :--- | :--- |
| **GET** | `/api/_nac/:resource` | Dynamic pagination, and search. |
| **POST** | `/api/_nac/:resource` | Automated Zod-backed payload validation and insertion. |
| **GET** | `/api/_nac/:resource/:id` | Precision record resolution via schema metadata. |
| **PATCH** | `/api/_nac/:resource/:id` | Partial updates with strict system-field protection. |
| **DELETE** | `/api/_nac/:resource/:id` | Validated record removal |
