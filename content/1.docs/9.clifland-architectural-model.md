...
* **`GET /api/_nac/_meta`**: A discovery endpoint that lets AI "read" your system's capabilities, relationships, and payload requirements without source code access.
